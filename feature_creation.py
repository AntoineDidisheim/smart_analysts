...
np.save(file='data/int_out/features_mat_simple',arr=all_feats_simple)
np.save(file='data/int_out/features_mat_std',arr=all_feats_std)
np.save(file='data/int_out/features_mat_std_original',arr=all_feats_std_original)
